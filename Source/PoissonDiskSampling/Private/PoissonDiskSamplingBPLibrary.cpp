...
#include "PoissonDiskSamplingBPLibrary.h"
#include "PoissonDiskSampling.h"

UPoissonDiskSamplingBPLibrary::UPoissonDiskSamplingBPLibrary(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{

}

TArray<FVector2D> UPoissonDiskSamplingBPLibrary::PoissonDiskSampling2D(float r, int k, FVector2D area)
{
...
TArray<FVector2D> UPoissonDiskSamplingBPLibrary::PoissonDiskSampling2DNearlyN(int N, int k, FVector2D area)
{
